...
@section('content')
        ...
        <div class="col-sm-10 col-md-8 col-md-offset-1 col-sm-offset-3">
        		...
        		<hr>
        		<h4><span class="glyphicon glyphicon-ok-sign"></span>As you have booked a motorbike you are suppose to pay a deposit of<strong> 5,000.</strong> </h4>
        		<hr>
        ...
        <a href="{{ route('checkout5')}}" class="btn btn-info btn-lg">
