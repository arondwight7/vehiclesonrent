...
@section('content')
        ...
        <div class="col-sm-10 col-md-8 col-md-offset-1 col-sm-offset-3">
        		...
        		<hr>
        		<h4><span class="glyphicon glyphicon-ok-sign"></span>As you have booked a hatchback you are suppose to pay a deposit of<strong> 20,000.</strong> </h4>
        		<hr>
        ...
        <a href="{{ route('checkout4')}}" class="btn btn-info btn-lg">
